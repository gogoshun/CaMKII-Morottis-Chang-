...
function get_camdyad_equations()
    ...
    @variables Pa_dyad(t) Ca4CaN_dyad(t) CaMCa4CaN_dyad(t) Ca2CaMCa4CaN_dyad(t) Ca4CaMCa4CaN_dyad(t) JCaDyad(t)
    @variables Ca_j(t)
    ...
    #eqs = append!(fluxesdyad_eqs, CaMdyad_eqs)
